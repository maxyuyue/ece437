...
add wave -noupdate /system_tb/DUT/CPU/DP/exmem/prEXMEM_in/outputPort
add wave -noupdate -divider exmem_out
add wave -noupdate /system_tb/DUT/CPU/DP/exmem/prEXMEM_out/outputPort
...
add wave -noupdate /system_tb/DUT/CPU/DP/memwb/prMEMWB_in/outputPort
add wave -noupdate /system_tb/DUT/CPU/DP/memwb/prMEMWB_in/memToReg
add wave -noupdate /system_tb/DUT/CPU/DP/memwb/prMEMWB_in/WEN
add wave -noupdate /system_tb/DUT/CPU/DP/memwb/prMEMWB_in/instr
add wave -noupdate -divider memwb_out
add wave -noupdate /system_tb/DUT/CPU/DP/memwb/prMEMWB_out/outputPort
add wave -noupdate /system_tb/DUT/CPU/DP/memwb/prMEMWB_out/memToReg
add wave -noupdate /system_tb/DUT/CPU/DP/memwb/prMEMWB_out/WEN
add wave -noupdate /system_tb/DUT/CPU/DP/memwb/prMEMWB_out/instr
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {201247 ps} 0}
