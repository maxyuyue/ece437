...
add wave -noupdate /system_tb/DUT/CPU/DP/idexValue/outputPort
...
add wave -noupdate /system_tb/DUT/CPU/DP/exmem/flush
...
add wave -noupdate /system_tb/DUT/CPU/DP/memwb/flush
...
WaveRestoreCursors {{Cursor 1} {260032 ps} 0}
...
update
WaveRestoreZoom {61310 ps} {862848 ps}
